...
<div class="col-md-12">
		...
		<form method="post" action="{{ url('product/product-image/update/') }}" enctype="multipart/form-data">
			@csrf
...
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">
<a href="{{ URL::to('product/multiimage/delete/'.$img->id) }}" class="btn btn-sm btn-danger" id="delete" title="Delete Data"><i class="fa fa-trash"></i> </a>
     </h5>
    <p class="card-text"> 
    	<div class="form-group">
...
<div class="col-md-12">
		...
		<form method="post" action="{{ url('product/product-thumbnail/update/'.$products->id) }}" enctype="multipart/form-data">
        @csrf
